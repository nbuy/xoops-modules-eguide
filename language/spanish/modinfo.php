...
define( "_MI_EGUIDE_EVENT_CONFIRM_TPL", "Confirmacion" );
...
// Notifications
define( '_MI_EGUIDE_GLOBAL_NOTIFY', 'Grobal en el modulo' );
...
if ( ! defined( '_MD_A_MYMENU_MYTPLSADMIN' ) ) {
	...
	define( '_MD_A_MYMENU_MYBLOCKSADMIN', 'Bloques de los modulos' );
	define( '_MD_A_MYMENU_MYLANGADMIN', 'Administracion de textos' );
