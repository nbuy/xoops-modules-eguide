...
define( "_MD_READMORE", "Mas..." );
define( "_MD_EMAIL", "EMail" );
define( "_MD_EMAIL_CONF", "Consultar el EMail" );
define( '_MD_EMAIL_CONF_DESC', 'Por favor, introduzca su direccion de EMail de nuevo para su confirmacion' );
define( '_MD_UNAME', 'Usuario' );
define( "_MD_SUBJECT", "Confirmar - {EVENT_DATE} {EVENT_TITLE}" );
define( "_MD_NOTIFY_EVENT", "Notificacion sobre nuevos Eventos" );
...
define( "_MD_RESERVED", "Tu Reservacion ya ha sido registrada" );
...
define( "_MD_NUMITEM_ERR", "Debe ser numerico" );
define( "_MD_MAIL_ERR", "Formato de eMail erroneo" );
define( '_MD_MAIL_CONF_ERR', 'Confirmar direccion de EMail no coinciden' );
define( "_MD_SEND_ERR", "No se pudo enviar el eMail" );
define( "_MD_DUP_ERR", "Ya existe una plaza reservada con tu direcion eMail" );
define( '_MD_DATE_ERR', 'The Date is out of range' );
define( '_MD_DATEDELETE_ERR', 'Stop remove the date, there is reservation exists' );
define( "_MD_DUP_REGISTER", "MLa Notificacion por eMail ya esta registrada" );
define( "_MD_REGISTERED", "Notificacion por eMail registrada" );

define( "_MD_RESERV_ACCEPT", "Enviando eMail de Confirmacion" );
define( "_MD_RESERV_STOP", "Reservations have been halted." );
define( "_MD_RESERV_CONF", "Informacion" );
...
define( "_AM_MAILGOOD", "Enviado con exito: %s" );
define( "_AM_SENDMAILNG", "Fallo de envio: %s" );

define( "_MD_RESERV_NOTFOUND", "No reservation or Allready cancelled." );
define( "_MD_RESERV_CANCEL", "Estas seguro de cancelar esta Reservacion?" );
define( "_MD_RESERV_CANCELED", "Tu Reservacion ha sido cancelada" );
define( "_MD_RESERV_NOCANCEL", "Imposible cancelar Reservacion despues del tiempo de cierre" );
define( "_MD_RESERV_NOTIFY", "%s\n\nEmail de peticion: %s\nReservacion para Evento: %s\n  %s\n" );
define( "_MD_RESERV_FULL", "La Reservacion ha sido cancelada. El Evento tiene el maximo de asistentes." );
define( '_MD_RESERV_TOMATCH', ' %d is too match (%d izquierda)' );
define( '_MD_RESERV_CLOSE', 'Proceso de Reservacion concluido' );
...
define( "_MD_SUMMARY", "Acompanantes" );
define( "_MD_SUM_ITEM", "Total de Acompanantes" );
...
define( '_MD_OPTION_VARS', 'Variables Opcion' );
...
define( '_MD_RESERV_DEFAULT_ITEM', "Nombre*,size=40\Curso,size=10,Acompanantes,size=5" );
...
define( "_MD_THISCOMESFROM", "Mas informacion sobre proximos Eventos aqui en %s" );
