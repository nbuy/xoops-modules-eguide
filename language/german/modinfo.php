...
define("_MI_EGUIDE_HEADLINE_DESC","N�chste Veranstaltungen");
...
define("_MI_EGUIDE_CATBLOCK_DESC","CW�hlen Sie Event-Kategorie");
...
define("_MI_EGUIDE_NOTIFYGROUP_DESC","Diese Gruppe ist Empf�nger der Benachrichtigungen");
define("_MI_EGUIDE_NEEDPOSTAUTH","Best�tigen lassen");
define("_MI_EGUIDE_NEEDPOSTAUTH_DESC","Neue Veranstaltung durch Admin best�tigen lassen");
define("_MI_EGUIDE_MAX_LISTITEM","Zus�tzliche Felder Teilnehmerliste");
define("_MI_EGUIDE_MAX_LISTITEM_DESC","Wievile zus�tzliche Felder sollen in der Teilnehmerliste angezeigt werden");
...
define("_MI_EGUIDE_MAX_EVENT_DESC","Wieviele Veranstaltungen sollen in der Veranstaltungs�bersicht angezeigt werden");
...
define("_MI_EGUIDE_MEMBER","Nur registrierte User k�nnen reservieren");
define("_MI_EGUIDE_MEMBER_DESC","Nur eingeloggte und registrierte User k�nnen reservieren");
define("_MI_EGUIDE_MEMBER_RELAX","Beide");
define("_MI_EGUIDE_ORDERCONF","Best�tigungsseite");
define("_MI_EGUIDE_ORDERCONF_DESC","Best�tigungsseite nach Reservierung anzeigen");
...
define("_MI_EGUIDE_LAB_PERSONS","Zus�tzliche Optionen Posten");
define("_MI_EGUIDE_LAB_PERSONS_DESC","Zus�tzliche Posten zus�tzliche optionale Einstellungen, wie ein Feldbezeichnung f�r wie viele Personen. (z.B. 'label_persons=Anzahl Tickets')");
define("_MI_EGUIDE_DATE_FORMAT","Datumsformat");
define("_MI_EGUIDE_DATE_FORMAT_DESC","Er�ffnungstermin Datum(Zeit) Anzeigeformat. Using PHP date function format.");
define("_MI_EGUIDE_DATE_FORMAT_DEF","D, d M Y");
define("_MI_EGUIDE_EXPIRE_AFTER","Ablaufzeit");
define("_MI_EGUIDE_EXPIRE_AFTER_DESC","Event gilt auf Startseite als abgelaufen, wenn Startzeit ist fr�her als in x Minuten");
define("_MI_EGUIDE_PERSONS","Weitere Artikel Optionen");
define("_MI_EGUIDE_PERSONS_DESC","Weitere Artikel optionsAdditional Artikel optionale Einstellungen, wie ein Feld Label f�r wie viele Personen. Beispiel: 'label_persons=Personen'. Siehe <a href=\"../../eguide/admin/help.php#form_options\">etwa eGuide Seite</a> weitere Informationen zu erhalten.");
define("_MI_EGUIDE_PLUGINS","Andere Module");
define("_MI_EGUIDE_PLUGINS_DESC","Sollen andere Module auf eGuide zugreifen d�rfen");
define("_MI_EGUIDE_COMMENT","Kommentare erlauben");
define("_MI_EGUIDE_COMMENT_DESC","Kommentare zu den Veranstaltungen erlauben");
define("_MI_EGUIDE_MARKER","Verf�gbarkeitsinformation");
...
define("_MI_EGUIDE_MARKER_DEF","0,[geschlossen]\n50,[viele Pl�tze verf�gbar]\n100,[noch einige Pl�tze verf�gbar]\n101,[Ausverkauft]\n");
...
define("_MI_EGUIDE_EVENT_CONFIRM_TPL", "Reservierungsbest�tigung");
define("_MI_EGUIDE_EDITDATE_TPL", "Er�ffnungsdatum bearbeiten");
...
define('_MI_EGUIDE_CATEGORY_BOOKMARK_DESC', 'Benachrichtigung f�r diese Veranstaltung');
...
if (!defined('_MD_A_MYMENU_MYTPLSADMIN')) {
    ...
    define('_MD_A_MYMENU_MYBLOCKSADMIN','Modul-Bl�cke');
