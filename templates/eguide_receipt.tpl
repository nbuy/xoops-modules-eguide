...
<tr>
  ...
  <td class="text-right">
    <div class="btn-group">
      ...
      <{if $exid}><a href="editdate.php?eid=<{$eid}>" class="btn btn-default" role="button"><{$smarty.const._MD_EDIT_EXTENT}></a><{/if}>
    </div>
  </td>
</tr>
</table>
...
<tr>
  <td><a href="entry.php?eid=<{$eid}><{if $exid}>&amp;sub=<{$exid}><{/if}>" class="btn btn-default btn-xs" role="button"><{$smarty.const._MD_RESERV_REGISTER}></a>&nbsp; 
...
<{/if}>
    <a href="receipt.php?rvid=<{$order.rvid}>" class="btn btn-info btn-xs" role="button"><{$smarty.const._MD_DETAIL}></a>
    <a href="receipt.php?op=edit&rvid=<{$order.rvid}>" class="btn btn-primary btn-xs" role="button"><{$smarty.const._EDIT}></a>
    <a href="reserv.php?op=cancel&rvid=<{$order.rvid}>" class="btn btn-danger btn-xs" role="button"><{$smarty.const._DELETE}></a>
  </td>
  <td><{$order.date}></td>
  <td><{$order.stat}></td>
  <td>
...
<div class="text-right">
  <div class="btn-group">
    <a href="receipt.php?op=csv&amp;eid=<{$eid}><{if $exid}>&amp;sub=<{$exid}><{/if}>" class="btn btn-default btn-sm" role="button"><{$smarty.const._MD_CSV_OUT}></a>
    <a href="export.php?eid=<{$eid}><{if $exid}>&amp;sub=<{$exid}><{/if}>" class="btn btn-default btn-sm" role="button"><{$smarty.const._MD_EXPORT_OUT}></a>
    <a href="sendinfo.php?eid=<{$eid}><{if $exid}>&amp;sub=<{$exid}><{/if}>" class="btn btn-default btn-sm" role="button"><{$smarty.const._MD_INFO_MAIL}></a>
  </div>
  <div class="btn-group">
    <a href="receipt.php?op=print&amp;eid=<{$eid}><{if $exid}>&amp;sub=<{$exid}><{/if}>" class="btn btn-default btn-sm" role="button"><span class="glyphicon glyphicon-print"></span></a>
  </div>
</div>
<{else}>
...
<tr class="head"><th><{$smarty.const._MD_SUM_ITEM}></th><th><{$smarty.const._MD_SUM}></th></tr>
<{foreach from=$citem key=label item=count}>
<tr class="<{cycle values="even, odd"}>"><td><{$label}></td><td align='right'><{$count}></td></tr>
<{/foreach}>
</table>
<{/if}>
</div>
